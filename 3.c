...
int main (void)
{
  ...
  /* A 256 bit key */
  unsigned char *key = (unsigned char *)truekey;
  ...
  unsigned char *plaintext =
                (unsigned char *)originaltxt;

  
  encrypt (originaltxt, strlen ((char*)originaltxt), truekey, iv,  encryptedtxt);
