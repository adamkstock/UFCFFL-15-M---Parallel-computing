...
int main (void)
{
  ...
  time1 = omp_get_wtime();//timer starts here 
          ...
          for (i4 = 0;i4 <= 9; i4++)
          {
            ...
            for (i5 = 0;i5 <= 9; i5++)
            {
              ...
              for (i6 = 0;i6 <= 9; i6++)
              {
                ...
                encrypt (originaltxt, strlen ((char*)originaltxt), testkey, iv,  work);//second encryption for comparison
                ...
                if (ret == 0)
                {
                  ...
                  {
                    hit = true ;
                    time2 = omp_get_wtime();//timer stop here 
